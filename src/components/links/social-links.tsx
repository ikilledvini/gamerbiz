      ...
      {items.map((item) => (
        <li key={item.label}>
          <a
            ...
            className="gbz-interactive flex h-11 w-11 items-center justify-center rounded-full text-white outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-foreground fine-hover:hover:-translate-y-0.5 fine-hover:hover:text-primary"
          >
