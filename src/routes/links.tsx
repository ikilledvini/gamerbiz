        ...
        <section className="mx-auto w-full max-w-[720px] px-5 sm:px-6">
          <div className="flex items-start justify-between gap-4">
            <Link
              ...
              className="flex h-11 w-11 items-center justify-center rounded-full border border-border bg-black text-foreground duration-200 ease-out [transition-property:transform,color,border-color] focus-visible:outline focus-visible:outline-2 focus-visible:outline-foreground active:scale-[0.96] [@media(hover:hover)_and_(pointer:fine)]:hover:border-primary [@media(hover:hover)_and_(pointer:fine)]:hover:text-primary"
            >
